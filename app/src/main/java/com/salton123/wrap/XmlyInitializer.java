...
public class XmlyInitializer {
     ...
     */
    public void init() {
        if (sApplication == null) throw new ExceptionInInitializerError("请执行attach方法！");
    ...
    private IXmAdsStatusListener iXmAdsStatusListener;
    ...
    public <T> XmlyInitializer notify(Class<T> targetClass, IXmPlayerStatusListener iXmPlayerStatusListener, IXmAdsStatusListener iXmAdsStatusListener) {
        this.iXmAdsStatusListener = iXmAdsStatusListener;
...
//                mPlayerManager.setPlayMode(XmPlayListControl.PlayMode.PLAY_MODEL_LIST);
    ...
    public void release() {
        ...
        XmPlayerManager.getInstance(sApplication).removePlayerStatusListener(iXmPlayerStatusListener);
        XmPlayerManager.getInstance(sApplication).removeAdsStatusListener(iXmAdsStatusListener);
