...
import com.salton123.xm.download.DownloadTrackActivity;
import com.salton123.xm.fragment.AlbumListFragment;
import com.salton123.xm.fragment.PayTrackFragment;
import com.salton123.xm.fragment.ScheduleFragment;
import com.salton123.xm.fragment.TracksFragment;
import com.salton123.xm.mvp.fm.MrGuoFragment;
import com.salton123.xm.pay.PayActivity;
 ...
 * @since Ver 1.1
 */
public class MainFragmentActivity extends BaseSupportActivity {
    ...
    private MrGuoFragment mRadiosFragment;
        ...
        public Fragment getItem(int position) {
            ...
            if (0 == position) {
                ...
                if (mRadiosFragment == null) {
                    mRadiosFragment = new MrGuoFragment();
                }
                f = mRadiosFragment;
            } else if (2 == position) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case 2:
                ...
                map.put(DTransferConstants.SEARCH_KEY, "上海");
                map.put(DTransferConstants.RADIO_CATEGORY_ID, "17");
            ...
            case 3:
                ...
                CommonRequest.getBoughtAlbums(map2, new IDataCallBack<AlbumList>() {
                    @Override
                ...
                map1s.put("ids" ,"21077146");
                CommonRequest.getBoughtTrackStatus(map1s, new IDataCallBack<BoughtStatuList>() {
                    @Override
                    public void onSuccess(BoughtStatuList object) {
                        System.out.println("object = [" + object + "]");
                    }
                ...
                map12.put("ids" ,"6922889");
                CommonRequest.getBoughtAlbumStatus(map12, new IDataCallBack<BoughtStatuList>() {
                    @Override
                    public void onSuccess(BoughtStatuList object) {
                    }
