...
import com.salton123.xm.fm.headerType.AlbumListFragment;
import com.salton123.xm.fm.headerType.SearchedTracksFragment;
...
//        });
    ...
    public void getIndexFmData() {
        ...
        mData.add(new Pair<Fragment, String>(BaseSupportFragment.newInstance(AlbumListFragment.class, "郭德纲"), "郭德纲"));
        mData.add(new Pair<Fragment, String>(BaseSupportFragment.newInstance(SearchedTracksFragment.class, "岳云鹏"), "岳云鹏"));
        mData.add(new Pair<Fragment, String>(BaseSupportFragment.newInstance(AlbumListFragment.class, "高晓松"), "高晓松"));
        mData.add(new Pair<Fragment, String>(BaseSupportFragment.newInstance(AlbumListFragment.class, "吴晓波"), "吴晓波"));
        mData.add(new Pair<Fragment, String>(BaseSupportFragment.newInstance(AlbumListFragment.class, "段子来了"), "段子来了"));
