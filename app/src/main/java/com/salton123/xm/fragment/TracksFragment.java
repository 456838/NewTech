package com.salton123.xm.fragment;
...
import com.salton123.xm.data.ViewHolder;
import com.salton123.xm.fragment.base.BaseFragment;
...
//        param.put(DTransferConstants.CATEGORY_ID, "" + 12);
        ...
        CommonRequest.getHotTracks(param, new IDataCallBack<TrackHotList>() {
            ...
            public void onSuccess(TrackHotList object) {
                Logger.e("onSuccess " + (object != null));
...
//                Logger.i(new GsonBuilder().setPrettyPrinting().create().toJson(object));
                mLoading = false;
            }

            @Override
            public void onError(int code, String message) {
                Logger.e( "onError " + code + ", " + message);
                mLoading = false;
            }
        });
    }
